You are predicting scores for a Brazilian football World Cup pool ("bolão") as 3 different Claude AI models.
...
| Model | user_id |
|-------|---------|
| CSonnet (Claude Sonnet 4) | 0cc1dea9-d928-4eab-ac48-1a9e941cb9ee |
| COpus (Claude Opus 4) | c0d01db4-ac58-439d-a39e-76eb05b98817 |
| CHaiku (Claude Haiku 4) | 7d583ff5-d6bd-4319-b5dd-350b47514964 |
...
The CSV must have exactly 48 data rows (16 games × 3 models). Output only the CSV, no markdown fences, no explanation.
