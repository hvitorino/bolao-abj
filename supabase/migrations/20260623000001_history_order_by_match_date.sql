-- Migration: corrige ordenação do histórico por match_date (timestamp) em vez de match_day+id
-- Dentro do mesmo dia, jogos devem aparecer em ordem decrescente de horário
